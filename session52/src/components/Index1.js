...
function Index1() {
  ...
  <div className="header_section">
    ...
    <div className="banner_section layout_padding">
      <div id="main_slider" className="carousel slide" data-ride="carousel">
        ...
        <a className="carousel-control-prev" href="#main_slider" role="button" data-slide="next">
          ...
          <div className="accordion" id="accordionExample">
            <div className="card">
              <div className="card-header" id="headingOne">
                <h2 className="mb-0">
                  <button type="button" className="btn btn-link w-100" data-toggle="collapse" data-target="#collapseOne">
            ...
            <div className="card">
              <div className="card-header" id="headingTwo">
                <h2 className="mb-0">
                  <button type="button" className="btn btn-link collapsed w-100" data-toggle="collapse" data-target="#collapseTwo">
            ...
            <div className="card">
              <div className="card-header" id="headingThree">
                <h2 className="mb-0">
                  <button type="button" className="btn btn-link collapsed w-100" data-toggle="collapse" data-target="#collapseThree">
                    <i className="fa fa-plus"/>
  ...
  <div className="clients_section layout_padding">
    <div id="custum_slider" className="carousel slide" data-ride="carousel">
      ...
      <a className="carousel-control-prev" href="#custum_slider" role="button" data-slide="next">
        <i className="fa fa-angle-left"/>
      </a>
      <a className="carousel-control-next" href="#custum_slider" role="button" data-slide="next">
        <i className="fa fa-angle-right"/>
      </a>
    </div>
  </div>
