  ...
  return (
    <div>
      ...
      <div className='w-[700px] border-solid border-2 border-black-600'>
        ...
        <br />
        <input
          className="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-[650px]"
          type="text"
          placeholder='Enter'
        />
        <br />
        ...
        <br />
        <input
          className="shadow appearance-none border rounded py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline w-[650px]"
          id="password"
          type="password"
        ...
        <input
          className="shadow appearance-none rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-[650px] border-solid border-2 border-red-600"
          id="email"
          type="email"
