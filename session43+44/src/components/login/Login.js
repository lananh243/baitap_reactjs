...
function Login() {
    ...
    <div className="login-form">
      <div className="login_picture">
        <img src="https://i.pinimg.com/originals/f7/ae/83/f7ae8313dc2040528c6be8d8a0253434.jpg" alt=""/>
      </div>
      <div className="form-login">
        ...
        <br />
        <br />
        <input type="text" className="w-[100%] border-solid border-2 border-black-600 h-[40px] rounded-md" placeholder="Placeholder content"/>
        <br />
        <br />
