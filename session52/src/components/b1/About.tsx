  ...
  >
    ...
    <div className="collapse navbar-collapse" id="navbarCollapse">
      <div className="navbar-nav ms-auto p-4 p-lg-0">
        <Link to="index.html" className="nav-item nav-link">
          Home
        </Link>
        <Link to="about.html" className="nav-item nav-link active">
          About
        </Link>
        ...
        <div className="nav-item dropdown">
          ...
          <div className="dropdown-menu m-0">
            ...
            <Link to="open.html" className="dropdown-item">
              Working Hours
            </Link>
            <Link to="testimonial.html" className="dropdown-item">
              Testimonial
            </Link>
            <Link to="Error.tsx" className="dropdown-item">
              404 Page
            </Link>
          </div>
        </div>
        <Link to="Contact.tsx" className="nav-item nav-link">
          Contact
        </Link>
      </div>
      <Link
