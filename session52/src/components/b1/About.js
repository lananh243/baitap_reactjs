  ...
  <nav className="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div className="collapse navbar-collapse" id="navbarCollapse">
      <div className="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <react_router_dom_1.Link to="about.html" className="nav-item nav-link active">
          About
        </react_router_dom_1.Link>
        ...
        <div className="nav-item dropdown">
          ...
          <div className="dropdown-menu m-0">
            ...
            <react_router_dom_1.Link to="Error.tsx" className="dropdown-item">
              404 Page
            </react_router_dom_1.Link>
          </div>
        </div>
        <react_router_dom_1.Link to="Contact.tsx" className="nav-item nav-link">
          Contact
        </react_router_dom_1.Link>
      </div>
          ...
          <div className="team-item">
            <div className="team-img position-relative overflow-hidden">
              ...
              <div className="team-social">
                <react_router_dom_1.Link className="btn btn-square" to="">
